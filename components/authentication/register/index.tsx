    ...
    <main className="w-full max-w-screen-2xl mx-auto">
      <section className="h-screen grid grid-cols-1 lg:grid-cols-4">
        ...
        <section className=" flex items-center justify-center " >
          <main >
          <h1 className="text-2xl font-bold text-center">E-Shop <span className="text_primary">BD</span> </h1>
            <h1 className="text-md font-medium text-center">Register your account</h1>
